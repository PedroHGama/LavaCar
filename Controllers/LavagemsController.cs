...
namespace WashCar.Controllers
{
    ...
    public class LavagemsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Lavagem.Include(l => l.Carro);
        ...
        {
            ViewData["CarroID"] = new SelectList(_context.Carro, "IDCarro", "Ano");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IDLavagem,TipoLavagem,DataLavagem,ValorLavagem,DescontoLavagem,CarroID")] Lavagem lavagem)
        {
            ...
            ViewData["CarroID"] = new SelectList(_context.Carro, "IDCarro", "Ano", lavagem.CarroID);
            return View(lavagem);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDLavagem,TipoLavagem,DataLavagem,ValorLavagem,DescontoLavagem,CarroID")] Lavagem lavagem)
        {
